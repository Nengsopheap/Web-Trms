      ...
      <div v-else>
        <div class="flex flex-wrap items-center justify-between">
          <div
            ...
            :key="assessment.id"
            class="flex-shrink-0 relative overflow-hidden bg-[#31247d] rounded-xl w-[330px] shadow-lg transition-all duration-300 group hover:shadow-[0_0_25px_#00ffff] hover:scale-[1.03] border border-transparent hover:border-cyan-300"
          >
            ...
            <router-link
              ...
              class="relative pt-10 px-10 flex flex-col items-center justify-center group-hover:scale-105 transition-transform duration-300 h-[400px]"
            >
