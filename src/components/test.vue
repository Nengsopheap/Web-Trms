  ...
  <div>
    <div v-if="lessons.length > 0">
      <ul>
        <li v-for="lesson in lessons" :key="lesson.id">
          <div class="flex flex-col">
            ...
            <div class="flex justify-between container">
              ...
              <div>
                <img src="/src/assets/image/cyber2.jpg" />
              </div>
            </div>

            <!-- Tips Header -->
            <div
              class="flex flex-row justify-center items-center mt-5 shadow-xl"
              style="background-color: #31247d"
            >
              <div class="flex flex-col gap-3">
                <div
                  class="text-white ml-36  w-[400px] font-kantumruy text-2xl"
                >
                  Best  Tips to Stay Safe Online.
                </div>
              </div>
              <div style="margin-right: 200px; width: 100px;">
                <div><img src="/src/assets//image/quiz.png" alt=""></div>
              </div>
            </div>

            <!-- Tips List -->
            <div
              class="min-h-screen flex justify-between gap-20 items-start mt-20 container"
            >
              <div>
                <img src="/src/assets/image/cyber4.png" />
              </div>

              <div class="flex flex-col gap-6">
                <!-- Tip Cards with AOS -->
                <div
                  v-for="(tipNum, index) in [1, 2, 3, 4, 5]"
                  :key="tipNum"
                ...
                >
                  {{
                    locale === "kh"
                      ? lesson[`tip${tipNum}_kh`]
                      : lesson[`tip${tipNum}_en`]
                  }}

                  <div
                    class="max-h-0 overflow-hidden group-hover:max-h-40 transition-all duration-300 mt-2"
                  >
                    <ul class="list-disc ml-5 text-sm font-normal">
                      <li>
                        {{
                          locale === "kh"
                            ? lesson[`tip${tipNum}_answer_kh`]
                            : lesson[`tip${tipNum}_answer_en`]
                        }}
                      </li>
                    </ul>
                  </div>
        ...
        <div>
          <main
              class="flex md:flex-row justify-center flex-col gap-[100px] md:gap-[40px] lg:gap-[100px] mx-auto w-full max-w-[1440px] min-w-[280px] py-8 px-4 lg:px-8"
            >
              <div class="max-w-[550px] mt-16">
                <p class="text-xl text-[#F9B800] font-kantumruy">
                  Quisque porttitor vitae vel amet neque scelerisque mattis.
                  Consectetur nibh velit magna consectetur leo.
                </p>
                <h2
                  class="text-[30px] leading-[48px] md:text-[50px] md:leading-[68px] mt-5 mb-16 text-black font-kantumruy"
                >
              ...
              <div
                class="flex md:mt-[-70px] items-center flex-col md:grid md:grid-cols-[220px_220px] lg:grid-cols-[250px_250px] grid-rows-8 gap-[60px] md:gap-[30px] lg:gap-[45px]"
              >
                <div
                  class="col-start-1 shadow-2xl col-end-2 row-start-1 row-end-4 bg-[#31247d] rounded-[40px] w-[250px] md:w-[220px] lg:w-[250px] p-8 md:p-4 lg:p-8"
                >
                  <svg
                  ...
                  <div>
                    <span
                      class="text-[72px] text-white leading-[93px] font-bold"
                      >1<span class="text-[#F9B800]">.</span></span
                    >
                    <p class="text-white">
                      <span class="text-2xl font-bold ">Phasellus Vitae</span
                      ><br /><span class="text-xl font-semibold">Quisque</span
                      ><br /><span class="text-lg font-extralight"
                        >Porttitor vitae vel amet</span
                      >
                    </p>
                  </div>
                </div>
                <div
                  class="col-start-2 col-end-3 row-start-2 row-end-5 bg-[#F9B800] rounded-[40px] w-[250px] md:w-[220px] lg:w-[250px] p-8 md:p-4 lg:p-8"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="50px"
                  ...
                  <div>
                    <span
                      class="text-[72px] text-black leading-[93px] font-bold"
                      >2<span class="text-[#fff]">.</span></span
                    >
                    <p>
                      <span class="text-2xl font-bold">Phasellus Vitae</span
                      ><br /><span class="text-xl font-semibold">Quisque</span
                ...
                <div
                  class="col-start-1 col-end-2 row-start-4 row-end-7 bg-[#F9B800] rounded-[40px] w-[250px] md:w-[220px] lg:w-[250px] p-8 md:p-4 lg:p-8"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="50px"
                  ...
                  <div>
                    <span
                      class="text-[72px] text-black leading-[93px] font-bold"
                      >3<span class="text-[#fff]">.</span></span
                    >
                    <p>
                      <span class="text-2xl font-bold">Phasellus Vitae</span
                      ><br /><span class="text-xl font-semibold">Quisque</span
                ...
                <div
                  class="col-start-2 col-end-3 row-start-5 row-end-8 bg-[#31247d] rounded-[40px] w-[250px] md:w-[220px] lg:w-[250px] p-8 md:p-4 lg:p-8"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="50px"
                  ...
                  <div>
                    <span
                      class="text-[72px] text-white leading-[93px] font-bold"
                      >4<span class="text-[#F9B800]">.</span></span
                    >
                    <p class="text-white">
                      <span class="text-2xl font-bold">Phasellus Vitae</span
                      ><br /><span class="text-xl font-semibold">Quisque</span
    ...
    <div v-else class="mt-6 text-gray-500">
      No lessons available for this assessment.
    </div>
  </div>
</template>
